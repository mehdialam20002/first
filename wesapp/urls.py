...
from .views import AddPostView, DeletePostView, UpdatePostView, home, register, login_user, logout_user, about, footer, home01, subscription, profile, HomeView, ArticleDetail, feed, home_body, UpdatePostView, DeletePostView, contact, premium_access, like_post, AddCommentView, mypost, user_change_pass
